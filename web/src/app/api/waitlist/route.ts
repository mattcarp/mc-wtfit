...
export async function POST(req: Request) {
  ...
  const r = await sendEmail({
    to: email,
    subject: 'What the fuck this? Confirm your email',
    text: `One click and you're on the list:\n\n${link}\n\nIf this wasn't you, ignore this email and nothing happens.\n\nWTF This. Proceeds from things you let go go to the Gozo SPCA by default.`,
